...
async function generateAccessToken() {
	...
	console.log("clientId from paypal page:", clientId);
	console.log("clientSecret from paypal page:", clientSecret);
	if (!response.ok) {
	...
	console.log("Access token from paypal page:", jsonData.access_token);
